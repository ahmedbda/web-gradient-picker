...
function App() {
  ...
  return (
    <div className={`min-h-screen flex flex-col items-center justify-between p-4 ${currentBackground}`}>
      ...
      <footer className="w-full text-center">
        <p> 
          <a className="text-descriptiontext text-white text-l underline" 
